...
public class MySQL_Inventory{
	...
	public static int selectProductIdByPackId(int pack_id) {
		Object inv_result[][] = MySQL.select(new String[]{"inv_id"}, "inventory", "where pack_id=" + pack_id);
		return (int)inv_result[0][0];
	}
	...
	public static void deleteFromInventoryByPackId(int pack_id) {
		MySQL.delete("inventory", "where pack_id=" + pack_id);
	}
}
